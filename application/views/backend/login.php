          ...
          <div class="container-fluid pe-0">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <li class="nav-item d-flex align-items-center">
                <a class="btn btn-round btn-sm mb-0 btn-outline-primary me-2" target="_blank" href="#">VM Technology</a>
              </li>
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="#" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-dark">Support : 9544390738</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form method="post" role="form" id="loginform" class="form-horizontal form-material" action="<?php echo base_url();?>login/check_login">
                    <label>User ID</label>  
                    <div class="mb-3">
                      <input class="form-control" type="email" name="email" required="" placeholder="<?php echo get_phrase('email');?>" aria-label="email" aria-describedby="email-addon" >
                    </div>
                    <label>Password</label>
                    <div class="mb-3" >
                      <input class="form-control" type="password" name="password" required="" placeholder="<?php echo get_phrase('passord');?>" aria-label="Password" aria-describedby="password-addon">
                    </div>
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" id="rememberMe" checked="">
                      <label class="form-check-label" for="rememberMe"><?php echo get_phrase('Remember Me');?></label>
                    </div>
                    <div class="text-center">
                    <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0"><?php echo get_phrase('Login');?></button>
                    </div>
                    <?php echo form_close();?>
                </div>
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('<?php echo base_url();?>/vm/assets/img/curved-images/curved6.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-8 mx-auto text-center mt-1">
          <p class="mb-0 text-secondary">
            ...
            </script> <?php echo $system_title;?>
          </p>
        </div>
      </div>
    </div>
  </footer>
  <!-- -------- END FOOTER 3 COPYRIGHT ------- -->
  <!--   Core JS Files   -->
