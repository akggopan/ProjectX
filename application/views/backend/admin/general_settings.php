...
<?php echo form_open(base_url() . 'setting/general_settings/update_setting/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                                    ...
                                    <label class="col-md-12" for="example-text"><?php echo get_phrase('System Currency');?>*</span>
                                        ...
                                        <div class="form-group">
                                    <label class="col-md-12" for="example-text"><?php echo get_phrase('language');?>*</span>
                                            <div class="col-md-12">
                                                <input type="text" name="language" value="<?php echo $this->db->get_where('settings', array('type' => 'language'))->row()->description;?>" class="form-control form-control-line">
                                            </div>
                                        </div>
