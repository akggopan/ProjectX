<div class="sidenav-header">
      ...
      <a class="navbar-brand m-0 href=" href="<?php echo base_url();?>admin/dashboard " target="_blank">
        <img src="<?php echo base_url();?>/vm/assets/img/logo.png" class="navbar-brand-img h-100" width="120"  alt="main_logo">
        <p><span class="ms-1 font-weight-bold">VM Technology</span></p>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?php if($page_name == 'dashboard') echo 'active';?> " href="<?php echo base_url();?>admin/dashboard">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php if($page_name == 'change_profile') echo 'active';?>" href="<?php echo base_url();?>admin/change_profile">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="<?php echo base_url();?>login/logout">
            ...
            <span class="nav-link-text xs-1">Sign Out</a></span>
          </a>
        </li>
      </ul>
    </div>
